...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/ext/packages/ext-theme' + suffix + '/build/resources/ext-theme' + suffix + '-all.css"/>');
    }
    // document.write('<script type="text/javascript" src="' + path + '/exterp/applogin/app.js"></script>');
    ...
    if (neptune) {
        ...
        neptunePath = (repoDevMode ? path + '/..' : path) +
            '/ext/packages/ext-theme-neptune/build/ext-theme-neptune' +
            (repoDevMode ? '-dev' : '') + '.js';
